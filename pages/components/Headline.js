  ...
  return (
    <div className="md:w-3/5 relative rounded-md">
        <div className="relative overflow-hidden bg-no-repeat min-h-max max-h-[450px] rounded-md">
            <Image src="/img/zebra.jpg" layout='responsive' width={6124} height={4816} />
        ...
        <div className="absolute bottom-0 left-0 p-4">
            ...
            <h1 className="mt-4 text-white font-bold text-xl md:text-2xl line-clamp-2">PUBG Mobile 1,5: Ignition Sudah Bisa Diunduh Oleh Pengguna Android dan iOS!</h1>
