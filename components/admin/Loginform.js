...
function Loginform() {
  return (
    <div className="block p-6 rounded-lg shadow-lg bg-white w-1/4">
  <form>
    ...
    <div className="form-group form-check mb-6">
      <input type="checkbox"
        ...
        id="exampleCheck1" />
      <label className="form-check-label inline-block text-gray-800" htmlFor="exampleCheck1">Check me out</label>
    </div>
